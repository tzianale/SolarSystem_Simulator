...
/// </summary>
[RequireComponent(typeof(FlexibleColorPicker.Scripts.FlexibleColorPicker))]
public class FCP_Persistence : MonoBehaviour {
    ...
    private FlexibleColorPicker.Scripts.FlexibleColorPicker fcp;
    ...
    private void Awake() {
        fcp = GetComponent<FlexibleColorPicker.Scripts.FlexibleColorPicker>();
        InitStatic();
    }
